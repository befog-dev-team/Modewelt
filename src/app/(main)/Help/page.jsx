  ...
  return (
    <div>
      ...
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold mb-4 text-[#f26744]">Modeweltjob Help Center</h1>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">For Job Seekers</h2>
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">1. Getting Started</h3>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">2. Finding Jobs</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">3. Applying for Jobs</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">4. Application Tracking</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">5. Showcase Your Expertise</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">For Employers</h2>
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">1. Setting Up Your Account</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">2. Posting Jobs</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">3. Reviewing Applications</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">4. Branding Opportunities</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">5. Subscriptions and Add-Ons</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
          <li>Explore premium features like analytics, targeted campaigns, and priority support.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">Common Questions (FAQs)</h2>
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">Job Seekers</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
          <li>How can I make my profile more appealing?</li>
          <li>What file formats are supported for resumes and portfolios?</li>
        </ul>
        <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">Employers</h3>
        <ul className="list-disc pl-6 text-gray-600 mb-4">
          <li>How do I purchase a subscription?</li>
          <li>What is the difference between standard and sponsored job postings?</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">Contact Us</h2>
