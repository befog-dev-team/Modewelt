        ...
        <div className="flex flex-col md:flex-row p-4 md:p-6 lg:p-8">
          ...
          <div className="w-full md:w-3/4 mt-6 md:mt-0 md:ml-6">
            ...
            <div className="flex justify-center gap-2 my-4">
              {["All", "Save", "in progress", "Archived"].map((status) => (
                <button
                  key={status}
            ...
            <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
              {filteredJobs.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center w-full bg-white p-6 rounded-lg">
