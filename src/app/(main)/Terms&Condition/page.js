    ...
    <div>
      ...
      <div className="min-h-screen bg-[#a2defa] flex flex-col items-center p-4">
        <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold mb-4 text-[#f26744]">Modeweltjob Terms and Conditions</h1>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">1. Acceptance of Terms</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">2. Eligibility</h2>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">3. User Responsibilities</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
              ...
              <ul className="list-disc pl-6">
                ...
                <li>Notify Modeweltjob immediately of any unauthorized access or suspicious activity related to your account.</li>
              </ul>
            </li>
            <li>
              <strong>Accurate Information:</strong>
              <ul className="list-disc pl-6">
                <li>All information you provide must be accurate, complete, and kept up-to-date. This includes personal details, job descriptions, and professional qualifications.</li>
              </ul>
            </li>
            <li>
              <strong>Prohibited Activities:</strong>
              <ul className="list-disc pl-6">
                <li>Post content that violates laws, regulations, or third-party rights.</li>
                <li>Share content that is defamatory, obscene, hateful, or otherwise objectionable.</li>
                <li>Misuse the platform for activities such as phishing, spam, or impersonation.</li>
                <li>Use bots, scrapers, or automated tools to access or interact with the platform.</li>
                <li>Provide false, misleading, or incomplete information in their profiles, job postings, or applications.</li>
              </ul>
            </li>
          </ul>

          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">4. Content Ownership and Use</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">5. Job Posting and Application Guidelines</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
              <strong>For Employers:</strong>
              <ul className="list-disc pl-6">
                <li>Job postings must be accurate, clear, and free of discriminatory language.</li>
                <li>Postings should be relevant to the fashion industry, including roles such as designers, stylists, merchandisers, and other related positions.</li>
                <li>Avoid duplicating content or using deceptive tactics to attract applicants.</li>
              </ul>
            </li>
            <li>
              <strong>For Job Seekers:</strong>
              <ul className="list-disc pl-6">
                <li>Profiles and applications must accurately reflect your qualifications, skills, and experience.</li>
                <li>Include truthful information and avoid misrepresentation.</li>
              </ul>
            </li>
            <li>
              <strong>Prohibited Conduct:</strong>
              <ul className="list-disc pl-6">
                <li>Employers may not solicit personal or financial information beyond what is necessary for the application process.</li>
                <li>Mislead candidates about job roles, compensation, or working conditions.</li>
                <li>Job seekers may not submit irrelevant or spam applications.</li>
              </ul>
            </li>
          </ul>

          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">6. Privacy</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">7. Termination</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
            ...
            <li>
              <strong>Termination by Modeweltjob:</strong> We reserve the right to suspend or terminate accounts for violations of these Terms, fraudulent behavior, or harmful activities. In such cases, Modeweltjob may retain or delete your content at its discretion, except where prohibited by law.
            </li>
          </ul>

          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">8. Disclaimers and Limitations of Liability</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">9. Indemnification</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">10. Changes to Terms</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">11. Governing Law and Dispute Resolution</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">12. Additional Provisions</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">13. Contact Information</h2>
          <p className="text-gray-600 mb-4">
            For questions, feedback, or support, reach out to us:
          </p>
          <p className="text-gray-600 mb-4">
            Email: <a href="mailto:contact.us@befog.in" className="text-[#f26744] underline">contact.us@befog.in</a><br />
          </p>
