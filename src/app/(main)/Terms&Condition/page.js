    ...
    <div>
      ...
      <div className="min-h-screen bg-purple-50 flex flex-col items-center p-4">
        <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold mb-4 text-[#944377]">Modeweltjob Terms and Conditions</h1>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">1. Acceptance of Terms</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">2. Eligibility</h2>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">3. User Responsibilities</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">4. Content Ownership and Use</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">5. Job Posting and Application Guidelines</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">6. Privacy</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">7. Termination</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
            <li>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">8. Disclaimers and Limitations of Liability</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">9. Indemnification</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">10. Changes to Terms</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">11. Governing Law and Dispute Resolution</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">12. Additional Provisions</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">13. Contact Information</h2>
          <p className="text-gray-600 mb-4">
