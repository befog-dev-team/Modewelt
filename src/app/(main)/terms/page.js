    ...
    <div>
      ...
      <div className="min-h-screen bg-purple-50 flex flex-col items-center p-4">
        <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold mb-4 text-[#944377]">Privacy Policy for Modeweltjob</h1>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">1. Information We Collect</h2>
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#944377]">a. Information You Provide to Us:</h3>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#944377]">b. Automatically Collected Information:</h3>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#944377]">c. Information from Third Parties:</h3>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">2. How We Use Your Information</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">3. Sharing Your Information</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">4. Your Choices and Rights</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">5. Data Retention</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">6. Data Security</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">7. International Data Transfers</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">8. Third-Party Links</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">9. Changes to This Privacy Policy</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#944377]">10. Contact Us</h2>
          <p className="text-gray-600 mb-4">
