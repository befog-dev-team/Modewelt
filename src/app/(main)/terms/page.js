...
const PrivacyPolicy = () => {
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-[#F9F6EE] dark:bg-gray-955 flex flex-col items-center p-4 transition-colors">
        <div className="max-w-4xl w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 border dark:border-gray-800 transition-colors">
