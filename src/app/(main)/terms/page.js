    ...
    <div>
      ...
      <div className="min-h-screen bg-[#a2defa] flex flex-col items-center p-4">
        <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">1. Information We Collect</h2>
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">a. Information You Provide to Us:</h3>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">b. Automatically Collected Information:</h3>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2 text-[#f26744]">c. Information from Third Parties:</h3>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">2. How We Use Your Information</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">3. Sharing Your Information</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">4. Your Choices and Rights</h2>
          <ul className="list-disc pl-6 text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">5. Data Retention</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">6. Data Security</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">7. International Data Transfers</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">8. Third-Party Links</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">9. Changes to This Privacy Policy</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-2 text-[#f26744]">10. Contact Us</h2>
          <p className="text-gray-600 mb-4">
