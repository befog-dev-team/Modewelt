  ...
  return (
    <div className="bg-[#daf59d]">
      ...
      <div className="p-6 md:p-12 min-h-[50vh] rounded-xl bg-[#f4f2ff] flex flex-col items-center">
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            ...
            {/* Button */}
            <button className="mt-4 bg-[#fc3fb4] text-white px-6 py-2 rounded-md shadow-md hover:bg-[#fc3fb4] transition-all duration-300">
              Search Candidates
            </button>
          </div>
        </div>
      ...
      <div className=" flex flex-col items-center justify-center min-h-screen p-6">
        ...
        <div className="max-w-[1192px] w-full my-8 border-t border-[#7b4fff] mt-10 p-[4px]" />
