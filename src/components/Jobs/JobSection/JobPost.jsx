        ...
        >
            ...
            <div className="flex justify-end sm:justify-center w-full sm:w-auto">
                <Link href={`jobDetails/${jobs.id}`} prefetch={true}>
                    <button className="w-[120px] h-[36px] flex justify-center items-center rounded-[4px] uppercase bg-[#f26744] text-white text-[14px] font-semibold hover:bg-gradient-to-l hover:from-[#a3527e] hover:to-[#c166a0] transition duration-300 ease-in-out">
